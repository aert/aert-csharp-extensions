...
namespace aert_csharp_extensions
{
    public class IdentifierHelper
    {
        ...
        /// specified radix (in the range [2, 80]).
        /// </summary>
        /// <param name="number">The number to convert.</param>
        /// <param name="radix">The radix of the destination numeral system (in the range [2, 80]).</param>
        /// <returns></returns>
        public static string DecimalToArbitrarySystem(long number, int radix)
        {
        ...
        /// radix (in the range [2, 80]) to decimal numeral system.
        /// </summary>
